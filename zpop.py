...
def z_score(x, mu, sigma):
    ...
    # Group 42: Richard Bennett, Jason Cole, Lina Nguyen

    # Your code goes between this comment and the return statement

    return (x - mu) / sigma  # Place the calculated z-score result between the return statement and this comment so
    # it will be returned by the z_score function


# This is our testing function. It compares and prints each population value with the expected score, actual score,
